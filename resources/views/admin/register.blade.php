        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input id="name" name="name" type="text" required autofocus
                    class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring focus:ring-green-300">
            </div>
            <div class="mb-4">
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('login') }}" class="text-green-600 hover:underline">Sudah punya akun? Login</a>
            </div>
        </form>
    </div>
</div>
